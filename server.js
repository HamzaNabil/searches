...
const connectionString = `mongodb+srv://hamza:hamza123@cluster0.inojw.mongodb.net/research-db?retryWrites=true&w=majority`;
mongoose
...
if (process.env.NODE_ENV == "production") {
  ...
  app.get("/enlang", (req, res) =>
    res.sendFile(__dirname + "/public/index_en.html")
  );
